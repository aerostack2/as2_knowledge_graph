...
public:
  KnowledgeGraphClient() : as2::Node("my_client_node") {
    client_create_node_ =
        this->create_client<as2_knowledge_graph_msgs::srv::CreateNode>(
            "create_node");
    client_remove_node_ =
        this->create_client<as2_knowledge_graph_msgs::srv::CreateNode>(
            "remove_node");
    client_create_edge_ =
        this->create_client<as2_knowledge_graph_msgs::srv::CreateEdge>(
            "create_edge");
    client_remove_edge_ =
        this->create_client<as2_knowledge_graph_msgs::srv::CreateEdge>(
            "remove_edge");
    client_add_property_node_ =
        this->create_client<as2_knowledge_graph_msgs::srv::CreateNode>(
            "add_property_node");
    client_add_property_edge_ =
        this->create_client<as2_knowledge_graph_msgs::srv::CreateEdge>(
            "add_property_edge");

    timer_ = this->create_wall_timer(
        20ms, std::bind(&KnowledgeGraphClient::timerCallback, this));
  }
...
public:
  ...
  rclcpp::Client<as2_knowledge_graph_msgs::srv::CreateNode>::SharedPtr
      client_create_node_;
  rclcpp::Client<as2_knowledge_graph_msgs::srv::CreateNode>::SharedPtr
      client_remove_node_;
  rclcpp::Client<as2_knowledge_graph_msgs::srv::CreateEdge>::SharedPtr
      client_create_edge_;
  rclcpp::Client<as2_knowledge_graph_msgs::srv::CreateEdge>::SharedPtr
      client_remove_edge_;
  rclcpp::Client<as2_knowledge_graph_msgs::srv::CreateNode>::SharedPtr
