...
public:
  KnowledgeGraphServer() : rclcpp::Node("my_knowledge_graph") {
    ...
    service_create_node_ =
        this->create_service<as2_knowledge_graph_msgs::srv::CreateNode>(
            "create_node",
            std::bind(&KnowledgeGraphServer::createNode, this, _1, _2));
    service_create_edge_ =
        this->create_service<as2_knowledge_graph_msgs::srv::CreateEdge>(
            "create_edge",
            std::bind(&KnowledgeGraphServer::createEdge, this, _1, _2));

    service_remove_node_ =
        this->create_service<as2_knowledge_graph_msgs::srv::CreateNode>(
            "remove_node",
            std::bind(&KnowledgeGraphServer::removeNode, this, _1, _2));
    service_remove_edge_ =
        this->create_service<as2_knowledge_graph_msgs::srv::CreateEdge>(
            "remove_edge",
            std::bind(&KnowledgeGraphServer::removeEdge, this, _1, _2));

    add_property_node_ =
        this->create_service<as2_knowledge_graph_msgs::srv::CreateNode>(
            "add_property_node",
            std::bind(&KnowledgeGraphServer::addPropertyNode, this, _1, _2));
    add_property_edge_ =
        this->create_service<as2_knowledge_graph_msgs::srv::CreateEdge>(
            "add_property_edge",
            std::bind(&KnowledgeGraphServer::addPropertyEdge, this, _1, _2));

    timer_ = this->create_wall_timer(
        20ms, std::bind(&KnowledgeGraphServer::timerCallback, this));
...
protected:
  ...
  rclcpp::Service<as2_knowledge_graph_msgs::srv::CreateNode>::SharedPtr
      service_create_node_;
  rclcpp::Service<as2_knowledge_graph_msgs::srv::CreateEdge>::SharedPtr
      add_property_edge_;
  rclcpp::Service<as2_knowledge_graph_msgs::srv::CreateEdge>::SharedPtr
      service_create_edge_;
  rclcpp::Service<as2_knowledge_graph_msgs::srv::CreateNode>::SharedPtr
  ...
  void createNode(
      const std::shared_ptr<as2_knowledge_graph_msgs::srv::CreateNode::Request>
          request,
      const std::shared_ptr<as2_knowledge_graph_msgs::srv::CreateNode::Response>
          response);
  void createEdge(
      const std::shared_ptr<as2_knowledge_graph_msgs::srv::CreateEdge::Request>
          request,
      const std::shared_ptr<as2_knowledge_graph_msgs::srv::CreateEdge::Response>
          response);
  void removeNode(
      const std::shared_ptr<as2_knowledge_graph_msgs::srv::CreateNode::Request>
          request,
